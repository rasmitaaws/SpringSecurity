...
import com.apps.rasmi.SpringApplicationContext;
import com.apps.rasmi.ui.request.UserLoginRequestModel;
...
public class UserAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest req,
        ...
        String token = Jwts.builder()
                ...
                .compact();
        UserDetailService userService = (UserDetailService)SpringApplicationContext.getBean("userServiceImpl");
